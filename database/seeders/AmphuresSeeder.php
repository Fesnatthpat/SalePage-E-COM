...
class AmphuresSeeder extends Seeder
{
    /**
     * Run the database seeds.
     * Populates the amphures table with initial data.
     */
    public function run()
    {
