...
@section('content')
    {{-- Alpine.js Data: รับค่ารูปภาพและข้อมูลจาก Controller --}}
    <div x-data="{
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="flex flex-col gap-4">
                        <div
                            ...
                            <img :src="activeImage" class="w-full h-full object-contain"
                                alt="Product {{ $product->pd_name }} Image">

                            {{-- ป้าย SALE (เพิ่มให้เหมือนหน้าแรก) --}}
                ...
                <div class="p-6 lg:p-10 border-t lg:border-r border-gray-200 lg:col-start-1 lg:row-start-2 bg-gray-50/50">
                    ...
                    <div class="text-gray-700 text-sm leading-7 space-y-4">
                        {{-- ตรวจสอบว่ามี field pd_details ไหม (ถ้าไม่มีใช้ pd_name แทนไปก่อน) --}}
